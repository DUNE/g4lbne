...
//  G4double StlShm_length = 208*in;
  ...
  G4double yo = -1*in; 
  G4double xp = LBNEData->HadrBox_length/2.0 - 6.0625*12*in;
  G4double yp = 0;
...
//  char no[3];
  ...
  G4Box*  expHadrBox = new G4Box("expHadrBox", LBNEData->HadrBox_width/2., LBNEData->HadrBox_height/2.0, LBNEData->HadrBox_length/2.0);
  ...
  for(G4int ii = 0;ii<8;ii++){
    CoreZ_pos = ii*Al_length + Al_length/2.0 - LBNEData->HadrBox_length/2.0 + core_offset; 
    sprintf(no, "%d", ii+1);
    volName = "Al_sBLK"; 
    volName.append(no);
  ...
  for(G4int ii = 0;ii<10;ii++){
    CoreZ_pos = ii*Stl_length + Stl_length/2.0 - LBNEData->HadrBox_length/2.0 + 8*Al_length+core_offset; 
    sprintf(no, "%d", ii+1);
    volName = "Stl_sBLK"; 
    volName.append(no);
  ...
  for (G4int ii = 0;ii<24;ii++){
    ...
    bbz_pos = (ii%12)/3*bb_length - LBNEData->HadrBox_length/2.0 + bb_length/2.0; 
    sprintf(no, "%d", ii+1);
    volName = "blu_sBLK"; 
    volName.append(no);
  ...
  for (G4int ii=0;ii<8;ii++){
    ...
    bbz_pos = ii%4*bb_length - LBNEData->HadrBox_length/2.0 + bb_length/2.0; 
    sprintf(no, "%d", ii+25);
    volName = "blu_sBLK"; 
    volName.append(no);
    BLK_solid[ii] = new G4Box(volName, bb_width/2.0, bb_height/2.0, bb_length/2.0);
    ...
    if(ii==0){
      ...
      volName = "stl_slab1";
      G4ThreeVector slabpos1 = G4ThreeVector(0, -Al_height/2.0 + CoreY_pos - 2*in/2.0, -LBNEData->HadrBox_length/2.0 + core_offset + 195.38*in/2.0);
      ...
      volName = "stl_slab2";
      volName.append(no);
      G4ThreeVector slabpos2 = G4ThreeVector(-bb_width, -bb_height*2.0 + 3.0*in/2.0 - 1.0*in - Al_height/2, -LBNEData->HadrBox_length/2.0 + 2*bb_length);
      ...
      volName = "stl_slab3";
      G4ThreeVector slabpos3 = G4ThreeVector(bb_width, -bb_height*2.0 + 3.0*in/2.0 - 1.0*in - Al_height/2.0, -LBNEData->HadrBox_length/2.0 + 2*bb_length);
      ...
      volName = "stl_slab4";
      G4ThreeVector slabpos4 = G4ThreeVector(0, Al_height/2.0 + 3.5*in, -LBNEData->HadrBox_length/2.0 + 2*bb_length);
      ...
      volName = "stl_slab5";
      G4ThreeVector slabpos5 = G4ThreeVector(0, Al_height/2.0 + CoreY_pos + 2.0*in/2.0, -LBNEData->HadrBox_length/2.0 + core_offset + 8*Al_length + 10*Stl_length/2.0);
  ...
  volName = "stl_slabL";
  G4ThreeVector slabpos5 = G4ThreeVector(-Al_width/2 - StlSlb_width/2.0,  CoreY_pos + in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_length - StlSlb_length/2.0);
  ...
  volName = "stl_slabR";
  G4ThreeVector slabpos6 = G4ThreeVector(Al_width/2 + StlSlb_width/2.0, CoreY_pos + in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_length - StlSlb_length/2.0);
  ...
  for (G4int ii=0;ii<8;ii++){
    ...
    bbz_pos = (ii/2)*bb_length - LBNEData->HadrBox_length/2.0 + bb_length/2.0; 
    sprintf(no, "%d", ii+49);
    volName = "blu_sBLK"; 
    volName.append(no);
  ...
  blockPos = G4ThreeVector(81*in + conc_width/2.0, -in - Al_height/2.0 - 4*bb_height + conc_height/2.0, -LBNEData->HadrBox_length/2.0+conc_length/2.0);
  ...
  blockPos = G4ThreeVector(-81*in - conc_width/2.0, -in - Al_height/2.0 - 4*bb_height + conc_height/2.0, -LBNEData->HadrBox_length/2.0+(conc_length-.9144*m)/2.0);
  ...
  blockPos = G4ThreeVector(-81*in - conc_width/2.0 + (conc_length-2*.9144*m)/2.0, -in-Al_height/2.0-4*bb_height+conc_height/2.0, -LBNEData->HadrBox_length/2.0 + conc_length + 10*in - conc_width/2.0);
  ...
  blockPos = G4ThreeVector(0, 4*in + Al_height/2.0 + bb_height*2.0 + 18.22*in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_width/2.0);
  ...
  blockPos = G4ThreeVector(-81*in - conc_width/2.0, -in - Al_height/2.0-4*bb_height+conc_height+18.22*in/2.0, -LBNEData->HadrBox_length/2.0 + conc_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0 + conc_height + 18.22*in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_length + 2*30*in/2.0);
  ...
  blockPos = G4ThreeVector(-3*bb_width/2.0 - 2*9.1*in/2.0, -LBNEData->HadrBox_height/2.0 + conc_height + 18.22*in + 30*in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0 + conc_height + 18.22*in + 30*in/2.0, -LBNEData->HadrBox_length/2.0 + 4*bb_length + 2*9.1*in/2.0);
  ...
  */
  ...
  G4Box*  expShldBox = new G4Box("expShldBox", LBNEData->HadrBox_width/2., LBNEData->HadrBox_height/2.0, CShld_length/2.0);
  ...
  blockPos = G4ThreeVector(1/2.0*A_height+(A_width+B_width)/2.0, -LBNEData->HadrBox_height/2.0+B_height/2.0, -CShld_length/2.0+B_length);
  ...
  blockPos = G4ThreeVector(-1/2.0*A_height-(A_width+B_width)/2.0, -LBNEData->HadrBox_height/2.0+1.5*B_height, -CShld_length/2.0+B_length);
  ...
  blockPos = G4ThreeVector(1/2.0*A_height+(A_width+B_width)/2.0, -LBNEData->HadrBox_height/2.0+1.5*B_height, -CShld_length/2.0+B_length/2.0);
  ...
  blockPos = G4ThreeVector(1/2.0*A_height+B_width/2.0, -LBNEData->HadrBox_height/2.0+1.5*B_height, -CShld_length/2.0+1.5*B_length);
  ...
  blockPos = G4ThreeVector(1/2.0*D_width+1/2.0*C_width, -LBNEData->HadrBox_height/2.0+C_height/2.0, -CShld_length/2.0+C_length/2.0);
  ...
  blockPos = G4ThreeVector(1/2.0*D_width+1/2.0*C_width, -LBNEData->HadrBox_height/2.0+C_height+A_width+C_height/2.0, -CShld_length/2.0+C_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0+C_height+A_width/2.0, -CShld_length/2.0+A_length);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0+D_height/2.0, -CShld_length/2.0+D_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0+D_height+A_width+D_height/2.0, -CShld_length/2.0+D_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0+2*B_height+J_height+3*in, -CShld_length/2.0+D_length/2.0);
  ...
  blockPos = G4ThreeVector(0, -LBNEData->HadrBox_height/2.0 + 2*B_height + 2*J_height + 3*in + 18.22*in/2.0, -CShld_length/2.0 + D_length/2.0);
